...
function princeDestructor(){

	app.stage.removeChild(background1);
	 //remove the KeyCaps to the stage
    app.stage.removeChild(sprites.keyQ);
    app.stage.removeChild(sprites.keyW);
    app.stage.removeChild(sprites.keyE);
    app.stage.removeChild(sprites.keyR);

    //remove the KeyCaps to the stage
    app.stage.removeChild(sprites.keyQPress);
    app.stage.removeChild(sprites.keyWPress);
    app.stage.removeChild(sprites.keyEPress);
    app.stage.removeChild(sprites.keyRPress);
    //remove player to the stage
    app.stage.removeChild(sprites.player);

    app.stage.removeChild(character1);
    app.stage.removeChild(character2);
    app.stage.removeChild(character3);
    app.stage.removeChild(character4);
    app.stage.removeChild(characterH);
    app.stage.removeChild(characterV);
